...
void crearTabla(tIndicePalabras	& tabla, const std::string &archivoInicial, tListaCadenas<std::string> & Totales, 
	...
	NoVisitados.capacidad = TAM_INI;
	Visitados.vector = new std::string[Visitados.capacidad];
	NoVisitados.vector = new std::string[NoVisitados.capacidad];
	...
	Visitados.vector = nullptr;
	//delete[] NoVisitados.vector;
	NoVisitados.vector = nullptr;
}
